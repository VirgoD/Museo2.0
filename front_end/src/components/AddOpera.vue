<template>
  <div class="container w-75 bg-light mt-5 p-4">
    <h3 class="pt-3 " style="text-align:center">Create New Opera</h3>
    <hr />
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <form id="insertOpera" v-on:submit.prevent>
            <div class="form-group">
              ...
              <p>ARTISTA:</p>
              <input v-model="collection.artista" placeholder="artista" name="artista">
            </div>
            <button
                @click="createOpera"
                type="submit"
...
export default {
  ...
  methods: {
    createOpera() {
      const form = document.getElementById("insertOpera");
      const formData = new FormData(form);
      axios
          .get("http://localhost:8080/api/v1/addOpera", {
            params: {
