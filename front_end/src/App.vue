...
<!--        <li v-if="showAdminBoard" class="nav-item">
        ...
        <li class="nav-item">
          <router-link v-if="currentUser" to="/collection" class="nav-link">Collection</router-link>
        </li>
        <li class="nav-item">
          <router-link v-if="currentUser" to="/opere" class="nav-link">Operas</router-link>
        </li>
      </div>
